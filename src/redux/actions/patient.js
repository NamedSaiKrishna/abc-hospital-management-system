import { GET_PATIENT, ADD_MEDICINE_PATIENT, ADD_DIAGNOSTIC_PATIENT, REMOVE_DIAGNOSTIC_PATIENT, REMOVE_MEDICINE_PATIENT, GET_ALL_PATIENTS, DELETE_PATIENT } from './types';
...
export const updatePatient = (b) => (dispatch, getState) => {
    ...
    axios.put(`/api/patients/${b.id}`, body, tokenConfig(getState))
        .then((res) => {
            dispatch({
                type: GET_PATIENT,
                payload: res.data
...
export const getAllPatients = () => (dispatch, getState) => {
    ...
    axios.get('/api/patients/', tokenConfig(getState))
        .then((res) => {
            dispatch({
...
export const deletePatient = (id) => (dispatch, getState) => {
    axios.delete(`/api/patients/${id}`, tokenConfig(getState))
        .then((res) => {
            dispatch({
                type: DELETE_PATIENT,
                payload: id
